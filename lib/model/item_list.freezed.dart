...
abstract class $ItemListCopyWith<$Res> {
  ...
  @useResult
  $Res call({String label, List<Item> items});
}
...
class _$_ItemList implements _ItemList {
  _$_ItemList({required this.label, required this.items});
  ...
  @override
  String toString() {
    return 'ItemList(label: $label, items: $items)';
  }
...
abstract class _ItemList implements ItemList {
  factory _ItemList(
      ...
      required final List<Item> items}) = _$_ItemList;
